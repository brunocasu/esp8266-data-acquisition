...
#define APP_VERSION "esp-m2-app-ap-continuous_v1.0"
...
const char* ssid_AP = "W08-AP-ESPM2"; // No password set
...
const char* coef_file_path = "/W08_coef.txt";
const char* coef_header_description = "C0;C1;C2;C3;C4;C5;C6;CRC;"; // Added at the creation of the Data file
const char* data_file_path = "/W08_raw_data.csv";
const char* data_csv_header_description = "Ctr;RawPressure;RawTemperature;Millis"; // Added at the creation of the Data file
